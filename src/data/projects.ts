...
const projects: Project[] = [
  {
    ...
    galleryImages: [
      "/images/solventum/solventum_card_background.jpg",
      "/images/solventum/solventum_card_background.jpg",
      "/images/solventum/solventum_card_background.jpg",
      "/images/solventum/solventum_card_background.jpg",
      "/images/solventum/solventum_card_background.jpg",
  ...
  },
  {
    ...
    galleryImages: [
      "/images/nvidia/nvidia_card_background.jpg",
      "/images/nvidia/nvidia_card_background.jpg",
      "/images/nvidia/nvidia_card_background.jpg",
      "/images/nvidia/nvidia_card_background.jpg",
      "/images/nvidia/nvidia_card_background.jpg",
  ...
  {
    id: "pods",
    client: "PODS Moving & Storage",
    title: "Modernizing the sales and service customer journey",
    summary: "Modernizing the sales and service customer journey for PODS Moving & Storage.",
    tags: ["Experience Design", "Sales", "Service"],
    ...
    summarySection: {
      subtitle: "Overview",
      title: "Sales and service transformation",
      text: "PODS needed a more cohesive and efficient experience for customers moving through sales and service. We led the design of a modernized journey that reduced friction and improved conversion and satisfaction.",
    },
    myRoleSection: {
      subtitle: "My Role",
      title: "Experience design lead",
      text: "I led discovery and design for the sales and service flows, working with business and technology partners to align touchpoints and systems.",
      numbers: [
        { value: 5, caption: "Touchpoints redesigned" },
        { value: 20, caption: "Percent improvement in completion (target)" },
        { value: 1, caption: "Unified journey from quote to move" },
      ],
    },
    solutionSection: {
      subtitle: "Solution",
      title: "End-to-end journey design",
      text: "We designed a unified journey from quote to move, with clear steps, consistent information, and support at key moments. The solution balanced business rules with a simple, transparent customer experience.",
    },
    impactSection: {
      subtitle: "Outcomes",
      title: "Outcome",
      text: "The modernized journey was implemented and is driving improved completion rates and customer satisfaction.",
      blocks: [
        {
          title: "Simpler for customers",
          body: "Customers had a single, clear path from getting a quote to completing their move, with fewer dead ends and less confusion.",
        },
        {
          title: "Easier for operations",
          body: "Sales and service teams could see the full journey and intervene when needed, improving efficiency and outcomes.",
        },
      ],
    },
  },
