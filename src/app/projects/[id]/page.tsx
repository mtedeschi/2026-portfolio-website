    ...
    >
      ...
      >
        <div className="w-full lg:max-w-[60%] flex flex-col gap-[clamp(1rem,3vw,1.5rem)]">
          ...
          <h1 className="text-[clamp(2.75rem,10vw,5rem)] font-bold leading-[1.1] tracking-tight">
            {project.title}
          </h1>
          <div className="flex flex-wrap gap-[clamp(0.5rem,1.25vw,0.75rem)]">
            {project.tags.filter(Boolean).map((tag, i) => (
              <span
                key={i}
                className="text-[clamp(0.75rem,1.5vw,0.875rem)] font-medium text-muted-foreground bg-muted/80 px-[clamp(0.5rem,1.25vw,0.75rem)] py-[clamp(0.25rem,0.5vw,0.375rem)] rounded-full"
              >
                {tag}
              </span>
            ))}
      ...
      >
        <div className="w-full flex flex-col gap-[clamp(2rem,5vw,3rem)]">
          <div className="w-full lg:max-w-[60%] flex flex-col gap-[clamp(1rem,3vw,1.5rem)]">
            ...
            <h2 className="text-[clamp(2rem,5.5vw,2.75rem)] font-bold leading-[1.1] tracking-tight">
      ...
      >
        <div className="flex flex-col gap-[clamp(3rem,8vw,5rem)]">
          <div className="w-full lg:max-w-[60%] flex flex-col gap-[clamp(1rem,3vw,1.5rem)]">
            ...
            <h2 className="text-[clamp(1.75rem,4.5vw,2.5rem)] font-bold leading-[1.1] tracking-tight">
